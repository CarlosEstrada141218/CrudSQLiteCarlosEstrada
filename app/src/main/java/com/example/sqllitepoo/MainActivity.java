   ...
   Modal ventanas = new Modal();
    ...
    public  void consuldesc (View view){
        ...
        if (inputED){
            ...
            Toast.makeText(this,"Ingrese el articulo por descripción ",Toast.LENGTH_SHORT).show();
        }
    ...
    public void modi (View view){
        ...
        if (inputET){
            ...
            if (conexion.mod(dato)){
                ...
                Toast.makeText(this,"No se encotro el articulo a modificar  ",Toast.LENGTH_SHORT).show();
